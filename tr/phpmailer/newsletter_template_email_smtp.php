...
try {
    ...
    $mail->setFrom('info@palmalifehotel.com', 'Message from Palmalife Hotel');             // Email Address and Name FROM
    $mail->addAddress('info@palmalifehotel.com', 'Jhon Doe');                            // Email Address and Name TO - Name is optional
    $mail->addReplyTo('noreply@palmalifehotel.com', 'Message from Palmalife Hotel');       // Email Address and Name NOREPLY
    $mail->isHTML(true);                                                       
    $mail->Subject = 'Message from Palmalife Hotel';                                // Email Subject   
   ...
   // Setup html content
    ...
    $mail->isHTML(true);
    $mail->Subject    = 'Thank you for join to Palmalife Newsletter'; // Custom subject
